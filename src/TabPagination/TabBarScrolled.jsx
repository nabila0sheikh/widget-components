...
/**
 * @property [children] {ReactElement} Tab element
 * @property [onTabSwitch] {Function} Tab clicked handler
 * @property [selected] {number} Selected tab index
 * @property [step] {number} Scroll step (items count)
 * @property [renderPrevButton] {Function} Function capable of rendering button responsible for scrolling right
 * @property [renderNextButton] {Function} Function capable of rendering button responsible for scrolling right
 * @property [renderTabContainer] {Function} Function capable of rendering tab container
 */
